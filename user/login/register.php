						...
						<div class="row">
							<div class="col-lg-12">
								<form id="register-form" method="post" role="form" >
									...
									<div class="form-group">
										<input type="text" name="semester" id="semester" tabindex="1" class="form-control" placeholder="Semester" value="" required >
									</div>
									<div class="form-group">
										<input type="text" name="enroll_no" id="enroll_no" tabindex="1" class="form-control" placeholder="Enrollment Number" value="" required >
									</div>
									<div class="form-group">
										<div class="row">
