                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                    ...
                                    <tr>
                                        <td>
                                            <select name="enr" class="form-control">
                                                <?php
                                                $res=mysqli_query($link,"select student_enrollment from issue_books where books_return_date='N'");
                            ...
                            {
                                $res=mysqli_query($link,"select * from issue_books where student_enrollment='$_POST[enr]' and books_return_date='N'");
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<td>"; ?> <a href="return.php?id=<?php echo $row["id"]; ?>">Return Books</a> <?php echo"</tr>";
                                    echo "</tr>";
                                }
                                echo "</table>";
                            }
